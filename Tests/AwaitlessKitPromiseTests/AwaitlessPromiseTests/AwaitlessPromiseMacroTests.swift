...
@Suite(.macros(["AwaitlessPromise": AwaitlessPromiseMacro.self], record: .missing), .tags(.macros))
struct AwaitlessPromiseMacroTests {
    
    @Test("Expand Promise wrapper for throwing function with return", .tags(.macros))
    ...
    @Test("Expand Promise wrapper for non-throwing function with return", .tags(.macros))
    ...
    @Test("Expand Promise wrapper for void-returning function", .tags(.macros))
    func promiseVoid() {
        assertMacro {
            """
            @AwaitlessPromise
    ...
    @Test("Expand Promise wrapper with prefix", .tags(.macros))
    ...
    @Test("Expand Promise wrapper with parameters", .tags(.macros))
    ...
    @Test("Expand Promise wrapper with availability attribute", .tags(.macros))
    ...
    @Test("Promise wrapper skips protocols", .tags(.macros))
